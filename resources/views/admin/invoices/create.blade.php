...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-5">
    <h3 class="fw-bold mb-0">Buat Invoice Baru</h3>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="itemsTable">
                            ...
                            <tbody id="itemsBody">
                                ...
                                <tr class="item-row">
                                    <td>
                                        <select name="items[0][product_id]" class="form-select form-select-sm product-select" data-control="select2" data-placeholder="Pilih Produk (Opsional)">
                                            <option value=""></option>
                                            @foreach($products as $product)
                                                <option value="{{ $product->id }}" data-price="{{ $product->price }}" data-name="{{ $product->name }}">{{ $product->code }} - {{ $product->name }}</option>
                                            @endforeach
                                        </select>
                                        <input type="text" name="items[0][description]" class="form-control form-control-sm mt-2 description-input" placeholder="Atau ketik deskripsi item" required>
                                    </td>
                                    <td>
                                        <input type="number" name="items[0][quantity]" class="form-control form-control-sm quantity-input" value="1" min="0.01" step="0.01" required>
                                    </td>
                                    <td>
                                        <input type="number" name="items[0][unit_price]" class="form-control form-control-sm price-input" value="0" min="0" step="0.01" required>
                                    </td>
            ...
            <div class="card card-flush mb-5">
                <div class="card-body">
                    <div class="mb-5">
                        ...
                        <textarea name="notes" class="form-control" rows="3" placeholder="Tambahkan catatan untuk pelanggan">{{ old('notes') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-5">
                        ...
                        <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                            ...
                            <option value="sent" {{ old('status') == 'sent' ? 'selected' : '' }}>Terkirim (Sent)</option>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="number" name="tax_amount" id="tax_amount" class="form-control summary-input" value="{{ old('tax_amount', 0) }}" min="0" step="0.01">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-sm">
                            <span class="input-group-text">Rp</span>
                            <input type="number" name="discount_amount" id="discount_amount" class="form-control summary-input" value="{{ old('discount_amount', 0) }}" min="0" step="0.01">
                        </div>
                    </div>
                    ...
                    <div class="mt-8">
                        <button type="submit" class="btn btn-primary w-100">
                            <i class="bi bi-save me-2"></i>Simpan Invoice
                        </button>
                    </div>
                </div>
            </div>
